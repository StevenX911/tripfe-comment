      ...
      <div class="gitment-comment-main">
        <div class="gitment-comment-header">
          ...
          ${ createDate.toString() !== updateDate.toString()
            ? ` • <span title="comment was edited at ${updateDate}">已重新编辑</span>`
            : ''
          }
...
function renderEditor({ user, error }, instance) {
  ...
  const disabledTip = user.login ? '' : '登录后评论'
  container.innerHTML = `
      ${ user.login
        ...
        : user.isLoggingIn
          ...
          : `<a class="gitment-editor-avatar" href="${instance.loginLink}" title="使用GitHub登录">
              ${githubIcon}
            </a>`
      }
    </a>
